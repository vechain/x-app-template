...
abstract contract VotesUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV1.VotesUpgradeable
  struct VotesStorage {
    IERC5805 _token;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV1.VotesUpgradeable")) - 1)) & ~bytes32(uint256(0xff))
