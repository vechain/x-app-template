...
abstract contract VotingSettingsUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV1.VotingSettings
  struct VotingSettingsStorage {
    uint32 _votingPeriod;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV1.VotingSettings")) - 1)) & ~bytes32(uint256(0xff))
