...
abstract contract ExternalContractsUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV1.ExternalContracts
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV1.ExternalContracts")) - 1)) & ~bytes32(uint256(0xff))
  ...
  function _setVoterRewards(IVoterRewardsV1 newVoterRewards) internal virtual {
    require(
      ...
      "XAllocationVotingGovernorV1: new voter rewards is the zero address"
    );
