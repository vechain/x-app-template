...
abstract contract RoundEarningsSettingsUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV1.RoundEarningsSettings
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV1.RoundEarningsSettings")) - 1)) & ~bytes32(uint256(0xff))
