...
/**
 * @title PassportSignalingLogicV1
 ...
 */
library PassportSignalingLogicV1 {
  // ---------- Events ---------- //
  ...
  function signalingThreshold(PassportStorageTypesV1.PassportStorage storage self) internal view returns (uint256) {
  ...
  function signalUser(PassportStorageTypesV1.PassportStorage storage self, address user) external {
  ...
  function removeSignalerFromAppByAppAdmin(PassportStorageTypesV1.PassportStorage storage self, address user) external {
  ...
  function setSignalingThreshold(PassportStorageTypesV1.PassportStorage storage self, uint256 threshold) external {
    self.signalsThreshold = threshold;
  }

  /// @notice Private function to remove a signaler from an app
  function removeSignalerFromApp(PassportStorageTypesV1.PassportStorage storage self, address user) public {
  ...
  function assignSignalerToApp(PassportStorageTypesV1.PassportStorage storage self, bytes32 app, address user) public {
  ...
  function _signalUser(PassportStorageTypesV1.PassportStorage storage self, address user, string memory reason) private {
