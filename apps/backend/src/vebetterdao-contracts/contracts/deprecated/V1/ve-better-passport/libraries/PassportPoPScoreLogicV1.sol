 ...
 */
library PassportPoPScoreLogicV1 {
  ...
  function thresholdPoPScore(PassportStorageTypesV1.PassportStorage storage self) internal view returns (uint256) {
  ...
  function appSecurity(
    PassportStorageTypesV1.PassportStorage storage self,
    bytes32 appId
  ) internal view returns (PassportTypesV1.APP_SECURITY) {
    return self.appSecurity[appId];
  }

  /// @notice Gets the round threshold for a user to be considered a person
  function roundsForCumulativeScore(PassportStorageTypesV1.PassportStorage storage self) internal view returns (uint256) {
    return self.roundsForCumulativeScore;
  }

  /// @notice Gets the decay rate for the cumulative score
  function decayRate(PassportStorageTypesV1.PassportStorage storage self) internal view returns (uint256) {
  ...
  /// @param appId - the app id of the action
  function registerAction(PassportStorageTypesV1.PassportStorage storage self, address user, bytes32 appId) external {
  ...
  function setThresholdPoPScore(PassportStorageTypesV1.PassportStorage storage self, uint208 threshold) external {
    self.popScoreThreshold.push(PassportClockLogicV1.clock(), threshold);
  }

  /// @notice Sets the number of rounds to consider for the cumulative score
  /// @param rounds - the number of rounds
  function setRoundsForCumulativeScore(PassportStorageTypesV1.PassportStorage storage self, uint256 rounds) external {
  ...
  function setDecayRate(PassportStorageTypesV1.PassportStorage storage self, uint256 newDecayRate) external {
  ...
  function _registerAction(
    ...
    if (self.appSecurity[appId] == PassportTypesV1.APP_SECURITY.NONE) {
      return;
    }
