...
/// @title GovernorFunctionRestrictionsLogicV3
...
library GovernorFunctionRestrictionsLogicV3 {
  ...
  function setWhitelistFunction(
    ...
    require(target != address(0), "GovernorFunctionRestrictionsLogicV3: target is the zero address");
   ...
   */
  function setIsFunctionRestrictionEnabled(GovernorStorageTypesV3.GovernorStorage storage self, bool isEnabled) external {
