...
/// @title GovernorDepositLogicV3 Library
...
library GovernorDepositLogicV3 {
   ...
   */
  function deposit(GovernorStorageTypesV3.GovernorStorage storage self, uint256 amount, uint256 proposalId) external {
    if (amount == 0) {
    ...
    GovernorStateLogicV3.validateStateBitmap(
      self,
      proposalId,
      GovernorStateLogicV3.encodeStateBitmap(GovernorTypesV3.ProposalState.Pending)
    );
   ...
   */
  function withdraw(GovernorStorageTypesV3.GovernorStorage storage self, uint256 proposalId, address depositer) external {
   ...
   */
  function depositThreshold(GovernorStorageTypesV3.GovernorStorage storage self) external view returns (uint256) {
   ...
   * @return uint256 The deposit threshold.
   */
  function _depositThreshold(GovernorStorageTypesV3.GovernorStorage storage self) internal view returns (uint256) {
