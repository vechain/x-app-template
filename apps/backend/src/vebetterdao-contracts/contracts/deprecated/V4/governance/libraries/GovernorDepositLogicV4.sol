...
/// @title GovernorDepositLogicV4 Library
...
library GovernorDepositLogicV4 {
   ...
   */
  function deposit(GovernorStorageTypesV4.GovernorStorage storage self, uint256 amount, uint256 proposalId) external {
    if (amount == 0) {
    ...
    GovernorStateLogicV4.validateStateBitmap(
      self,
      proposalId,
      GovernorStateLogicV4.encodeStateBitmap(GovernorTypesV4.ProposalState.Pending)
    );
   ...
   */
  function withdraw(GovernorStorageTypesV4.GovernorStorage storage self, uint256 proposalId, address depositer) external {
   ...
   */
  function depositThreshold(GovernorStorageTypesV4.GovernorStorage storage self) external view returns (uint256) {
   ...
   * @return uint256 The deposit threshold.
   */
  function _depositThreshold(GovernorStorageTypesV4.GovernorStorage storage self) internal view returns (uint256) {
