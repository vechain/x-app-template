...
/// @title GovernorFunctionRestrictionsLogicV4
...
library GovernorFunctionRestrictionsLogicV4 {
  ...
  function setWhitelistFunction(
    ...
    require(target != address(0), "GovernorFunctionRestrictionsLogicV4: target is the zero address");
   ...
   */
  function setIsFunctionRestrictionEnabled(GovernorStorageTypesV4.GovernorStorage storage self, bool isEnabled) external {
