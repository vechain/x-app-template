...
/// @title GovernorClockLogicV4 Library
...
library GovernorClockLogicV4 {
   ...
   */
  function clock(GovernorStorageTypesV4.GovernorStorage storage self) external view returns (uint48) {
